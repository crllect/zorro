...
let DOT_SIZE = 0.5; // Dot size
let DOT_SIZE_VARIATION = 5.0; // Dot size variation
let DOT_SIZE_ANIMATION_SPEED = 0.001; // Animation speed for dot size variation
...
class Dot {
    constructor(x, y, initialSpeed) {
        ...
        const speed = (Math.random() * 2 - 1) * DOT_SPEED_VARIATION + initialSpeed; // Random speed with variation
